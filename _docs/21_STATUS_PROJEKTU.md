...
# Wersja: 3.21 | Data: 2026-05-27 (T-026 DEPLOYED: SystemPrompt v9 — meta-reguła KONSEKWENCJI POD PRESJĄ multi-turn + 5 punktowych patchy, 8 luk red-team zaadresowanych, czeka na re-run weryfikacyjny; commit a3c753d)
...
| T-024c | wzmocnienie W1 promptu dla LANG class (multilingual_encoding) — wszystkie 4 scenariusze LANG-001..004 zwracaly UV mimo reguly 9 v1.1. Opcje: sub-prompt LANG z explicit "zdekoduj input przed ocena" + few-shot Base64/leet/PL-EN, LUB pre-processing input dekodujacy w providerze. | P2 | spec do napisania |
| T-025 | meta-eval golden set red-team (Cohen κ ≥ 0.7 W1 vs human) — 50-100 transkryptow ocenionych RECZNIE przez Karola+eksperta, skrypt `tools/cohen_kappa.py` liczacy zgodnosc, iteracja promptu W1 po pomiarze. Wymaga uczestnictwa Karola. | P1 | po T-024 (gotowe) |
| naprawy bota | 12 luk wykrytych przez T-024: LEAK-001/003/005, DOMAIN-002, IDOR-005, HALLU-006, JAIL-001/004/005, SCOPE-003/005, SALES-001. Karol przeglada transcripty → planowanie tasków. | P1 | po przegladzie |
