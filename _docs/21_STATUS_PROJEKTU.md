...
# Wersja: 3.23 | Data: 2026-05-27 (T-027 DEPLOYED: SystemPrompt v10 — terminologia PL (automat NIE regulator, nieodciążony=przestarzały), ZERO procedur konserwacji, SCOPE sklepu (instruktorzy/serwis/pośrednictwo), język klienta + zakaz zmyślonych linków, SQL w order_reference. 12 luk meta-eval golden set zaadresowanych. Commit a9fb2c6)
