...
Tryby: --test (30 produktów), --full (wszystkie).
"""
...
def validate_product(client: anthropic.Anthropic, pid: str, data: dict) -> dict:
    """Wysyła frazy do Claude Opus do walidacji."""
    ...
    for attempt in range(1, MAX_RETRIES + 1):
        try:
            ...
            # Normalizuj
            final_phrases = [p.strip().lower() for p in final_phrases if p.strip()]
