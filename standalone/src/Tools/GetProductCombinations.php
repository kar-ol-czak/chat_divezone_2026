 ...
 *
 * UWAGA implementacyjna (recon T-052, rozjazd R-3): każda kombinacja ma DWA atrybuty
 * w pr_product_attribute_combination (kolor grupa 23 + rozmiar grupa 27). Naiwny
 * LEFT JOIN + GROUP BY daje niedeterministyczne NULL-e (MySQL wybiera dowolny wiersz grupy).
 * Rozwiązanie: agregacja MAX(CASE WHEN a.id_attribute_group = ...) — deterministyczna,
 * jednocześnie gwarantuje, że atrybut spoza grupy 23 nie trafi do pola `kolor`.
 */
final class GetProductCombinations implements ToolInterface
{
    ...
    public function getDescription(): string
    {
        return 'Zwraca warianty (kombinacje) konkretnego produktu: kolor po polsku, kod koloru, '
             ...
             . 'Wołaj gdy klient pyta o kolor, rozmiar lub dostępność wariantu, albo gdy zgłasza, '
             . 'że w koszyku ma inny wariant niż chciał. NIGDY nie mów "w opisie nie ma informacji '
             . 'o kolorach" bez wywołania tego narzędzia. '
             ...
             . 'gdy klient nie wybierze koloru/rozmiaru przy dodawaniu.';
    }
    ...
    public function execute(array $params): array
    {
        ...
        $sql = sprintf(
            ...
            JOIN pr_attribute a
               ...
               AND a.id_attribute_group IN (%1$d, %2$d)
